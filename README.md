...
<p align="center">
  <b>[ 🇮🇷 فارسی ]</b> &nbsp;•&nbsp; <b>[ 🇬🇧 English ]</b> &nbsp;•&nbsp; <b>[ 🚀 Quick Start ]</b> &nbsp;•&nbsp; <b>[ 🛠️ Tech Stack ]</b> &nbsp;•&nbsp; <b>[ 📡 Server Setup ]</b>
</p>
...
📦 نحوه بیلد و ساخت فایل APK | Build from Source
پیش‌نیازها:
Android Studio (نسخه Koala / Ladybug یا جدیدتر)
JDK 17
...
# ۲. اجرای دستور کامپایل و بیلد
./gradlew assembleRelease
📍 فایل خروجی APK در مسیر app/build/outputs/apk/release/ قرار می‌گیرد.
